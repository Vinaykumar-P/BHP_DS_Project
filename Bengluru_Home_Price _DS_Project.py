...
df1 = pd.read_csv('F:\My Dataset\Bengaluru_House_Data.csv')
df1.head()
...
def remove_pps_outliers(df):
    ...
    for key, subdf in df.groupby('location'):
        ...
        df_out = pd.concat([df_out, reduced_df],ignore_index=0)
    return df_out
...
def plot_scatter_chart(df, location):
    ...
    plt.scatter(bhk2.total_sqft, bhk2.price_per_sqft, color='orange', label = '2 bhk', s= 50)
